...
from tracker.window_tracker import start_tracking, stop_tracking
...
def home():
    ...
    # Check actual tracker state
    tracking_status = "Started" if tracker_thread and tracker_thread.is_alive() else "Stopped"
    ...
    if request.method == "POST":
        ...
        if action == "start":
            ...
            if tracker_thread is None or not tracker_thread.is_alive():
                ...
                tracker_thread = threading.Thread(target=start_tracking)
